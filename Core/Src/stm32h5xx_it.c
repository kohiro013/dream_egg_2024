...
/* USER CODE BEGIN PFP */
extern void LED_ToggleBinary(uint8_t);
// 割り込み処理を記述した関数群
extern void Interrupt_Main( void );
extern void Interrupt_Sub( void );
...
extern DMA_NodeTypeDef Node_GPDMA2_Channel2;
extern DMA_QListTypeDef List_GPDMA2_Channel2;
